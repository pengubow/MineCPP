...
void LevelRenderer::compileSurroundingGround() {
    ...
    glBindTexture(GL_TEXTURE_2D, this->textures->getTextureId("resources/textures/rock.png"));
    float var10 = 0.5f;
    ...
    glBindTexture(GL_TEXTURE_2D, this->textures->getTextureId("resources/textures/water.png"));
...
void LevelRenderer::renderClouds(float var1) {
    ...
    glEnable(GL_TEXTURE_2D);
    glBindTexture(GL_TEXTURE_2D, textures->getTextureId("resources/textures/clouds.png"));
